        ...
        <div class="col-xl-12 mx-auto">
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('settings.taxs.update', $tax) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 pb-3">
                                <label for="input1" class="form-label">Name</label>
                                <input type="text" name="name" required value="{{ old('name', $tax->name) }}"
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 pb-3">
                                ...
                                <input type="text" name="rate" required value="{{ old('rate', $tax->rate) }}"
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 pb-3">
                                ...
                                <select name="active" id="active"
                                    ...
                                    <option value="{{ $key }}"
                                        {{ old('active', $tax->Active) == $key ? 'selected' : '' }}>
                                        {{ $active }}
                                    </option>
                                    @endforeach
                                </select>
