        ...
        <div class="col-4 mx-auto">
            <div class="card">
                ...
                <div class="d-flex justify-content-end m-3">
                    <a href="{{ url('restaurant-order/print-cart/'. $restaurant_cart_order_id ) }}" class="btn btn-outline-primary btn-sm px-2 ms-3">Print Bill</a>
                    <a href="{{ url('restaurant-order/print-docket/'. $restaurant_cart_order_id ) }}" class="btn btn-outline-primary btn-sm px-2 ms-3">Print Docket</a>
                    <button type="button" class="btn btn-sm btn-outline-danger px-2 ms-3 clear-cart">Clear</button>
                    <button type="button" class="btn btn-sm btn-outline-success px-2 ms-3" data-bs-toggle="modal" data-bs-target="#exampleModal">Proceed </button>
                </div>
                @endif
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul class="nav nav-tabs nav-primary" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" data-bs-toggle="tab" href="#continue-without-payment" role="tab"
                            aria-selected="false" tabindex="-1">
                            <div class="d-flex align-items-center">
                                <div class="tab-icon"><i class="bx bx-user-pin font-18 me-1"></i>
                                </div>
                ...
                <div class="tab-content py-3">
                    ...
                    <div class="tab-pane fade" id="continue-without-payment" role="tabpanel">
                        <form method="post" action="{{ url('restaurant-orders') }}">
                            ...
                            <input type="hidden" class="form-control" name="amount" id="credit-amount-paid">
...
@endsection
<script>
    var restaurantCartOrderId = '{{ $restaurant_cart_order_id }}';
