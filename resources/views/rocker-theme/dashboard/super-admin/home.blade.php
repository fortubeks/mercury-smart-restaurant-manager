                ...
                <div class="card radius-10 overflow-hidden mb-0 shadow-none border">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="text-danger ms-auto font-30"><i class="bx bx-group"></i>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card radius-10 overflow-hidden mb-0 shadow-none border">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="text-success ms-auto font-30"><i class="bx bx-receipt"></i>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card radius-10 overflow-hidden mb-0 shadow-none border">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="text-warning ms-auto font-30"><i class="bx bx-cycling"></i>
                            </div>
                        </div>
                    </div>
